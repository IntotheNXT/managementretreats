...
if (facilitatorSection && !facilitatorSection.querySelector('.facilitator-profiles')) {
  ...
  const profiles = {
    nl: [
      ['fons-trompenaars','Fons Trompenaars','Cultuur, dilemma’s & internationaal leiderschap','Internationaal expert in cultuur en leiderschap, met ruim drie decennia ervaring in het begeleiden van leiders en organisaties.','Cultuur & waarden · Dilemma thinking · Global leadership',['culture','collaboration']],
      ['bas-kemme','Bas Kemme','Strategie, innovatie & aanpassingsvermogen','Helpt managementteams strategische richting, innovatiekracht en organisatieverandering te verbinden aan concrete performance.','Future-back strategy · Innovation · Culture transformation · Bureaucracy busting',['strategy','ai','innovation','culture']],
      ['behdad-shahsavari','Behdad Shahsavari','AI, strategie & transformatie','Combineert senior ervaring in strategieconsulting, industrie, ventures en digitale transformatie.','AI strategy · Corporate strategy · Digital transformation · Operating models',['strategy','ai','innovation']],
      ['marijke-shahsavari-jansen','Marijke Shahsavari-Jansen','Strategie, samenwerking & stakeholderfacilitatie','Begeleidt leiders en teams bij strategieontwikkeling, samenwerking en complexe vraagstukken met meerdere stakeholders.','Strategy · Collaboration · Stakeholder alignment · Team facilitation',['strategy','collaboration']],
      ['niels-janssen','Niels Janssen','Strategie, facilitatie & executive coaching','Coacht al meer dan 15 jaar individuen en teams en combineert dat met senior facilitatie en de hoogste UK-accreditatie als facilitator.','Strategy development · Breakthrough sessions · Executive coaching · Facilitation',['strategy','leadership','collaboration','coaching']],
      ['genieke-hertoghs','Genieke Hertoghs','Leiderschap, invloed & gedragsverandering','Maakt gedragswetenschap praktisch en helpt leiders draagvlak, eigenaarschap en intrinsieke motivatie versterken.','Behavioural change · Influence · Ownership · Leadership',['leadership','feedback']],
      ['robbert-wolff','Robbert Wolff','Leiderschapsvaardigheden & moeilijke gesprekken','Gespecialiseerd in praktische leiderschapsvaardigheden, omgaan met weerstand en het geven en ontvangen van feedback.','Leadership skills · Feedback · Resistance · Difficult conversations',['leadership','feedback','wellbeing']],
      ['sabine-de-rooij','Sabine de Rooij','Werkplekwelzijn, mentale gezondheid & preventie','Bedrijfspsycholoog en coach met ruim 20 jaar ervaring in het creëren van veilige, gezonde werkomgevingen en het voorkomen van langdurige uitval.','Burn-outpreventie · Veerkracht · Psychologische veiligheid · Workplace wellbeing',['wellbeing','coaching']],
      ['nemos-kostoulas','Nemos Kostoulas','Productinnovatie & digitale ventures','Helpt organisaties ideeën vertalen naar gevalideerde digitale producten en nieuwe ventures, van discovery tot product-market fit.','Product innovation · Digital ventures · Product strategy · Product-market fit',['ai','innovation']],
    ...
    en: [
      ['fons-trompenaars','Fons Trompenaars','Culture, dilemmas & global leadership','An internationally recognised expert in culture and leadership with more than three decades of experience advising leaders and organisations.','Culture & values · Dilemma thinking · Global leadership',['culture','collaboration']],
      ['bas-kemme','Bas Kemme','Strategy, innovation & organisational adaptability','Helps management teams connect strategic direction, innovation and organisational change to measurable performance.','Future-back strategy · Innovation · Culture transformation · Bureaucracy busting',['strategy','ai','innovation','culture']],
      ['behdad-shahsavari','Behdad Shahsavari','AI, strategy & transformation','Combines senior experience in strategy consulting, industry, ventures and digital transformation.','AI strategy · Corporate strategy · Digital transformation · Operating models',['strategy','ai','innovation']],
      ...
      ['genieke-hertoghs','Genieke Hertoghs','Leadership, influence & behavioural change','Turns behavioural science into practical tools that help leaders build buy-in, ownership and intrinsic motivation.','Behavioural change · Influence · Ownership · Leadership',['leadership','feedback']],
      ['robbert-wolff','Robbert Wolff','Leadership skills & difficult conversations','Specialises in practical leadership skills, handling resistance, and giving and receiving feedback, particularly in expert environments.','Leadership skills · Feedback · Resistance · Difficult conversations',['leadership','feedback','wellbeing']],
      ['sabine-de-rooij','Sabine de Rooij','Workplace wellbeing, mental health & prevention','Business psychologist and coach with more than 20 years of experience creating safe, healthy workplaces and helping prevent long-term absence.','Burnout prevention · Resilience · Psychological safety · Workplace wellbeing',['wellbeing','coaching']],
      ['nemos-kostoulas','Nemos Kostoulas','Product innovation & digital ventures','Helps organisations turn ideas into validated digital products and new ventures, from discovery to product-market fit.','Product innovation · Digital ventures · Product strategy · Product-market fit',['ai','innovation']],
      ['olivier-rikken','Dr. Olivier Rikken','AI, emerging technology & digital resilience','Olivier helps organisations prepare for the impact of AI, quantum computing, blockchain and other emerging technologies, with a strong focus on governance, resilience and business continuity.','AI strategy · Future tech readiness · Digital resilience · Governance · Business continuity',['ai']]
    ]
  }[currentLang];
